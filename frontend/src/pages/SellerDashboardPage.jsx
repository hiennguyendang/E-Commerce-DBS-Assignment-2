                ...
                <tr key={p.product_id}>
                  ...
                  <td>
                    {p.min_price === p.max_price
                      ...
                      : `${formatCurrencyVN(p.min_price)} - ${formatCurrencyVN(
                          p.max_price
                        )}`}
                  </td>
                  ...
                  <td>
                    <button
                      ...
                      onClick={() => navigate(`/app/product/${p.product_id}`)}
                    >
              ...
              {orders.length === 0 ? (
                ...
                orders.map((o) => (
                  <tr key={o.order_id}>
                    ...
                    <td>{o.item_count}</td>
                    <td>{formatCurrencyVN(o.total_amount)}</td>
                    <td>{mapOrderStatusVN(o.order_status)}</td>
                    <td>
                      {o.created_at
